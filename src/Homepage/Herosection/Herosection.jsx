  ...
  return (
    <div className="mx-auto container ">
      <div className="text-center py-7 px-7 mb-7">
        <h1 className="tracking-tighter pb-7 text-6xl font-extrabold text-focus-in">Hub of <span className="text-custompurple">GiftCards</span> & <span className="text-custompurple">Digital Payment</span> Solutions</h1>
